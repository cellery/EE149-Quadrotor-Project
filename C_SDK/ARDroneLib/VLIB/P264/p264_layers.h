...
#define MAKE_START_CODE_P264(gob)      ( P264_CODEC | (gob) )
#define PICTURE_START_CODE_P264        MAKE_START_CODE_P264(0)
#define PICTURE_END_CODE_P264          MAKE_START_CODE_P264(0x1F)
